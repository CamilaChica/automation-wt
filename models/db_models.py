...
class RFQ(BaseModel):
    ...
    workflow_state: str = Field("NEW_RFQ", description="Canonical RFQ lifecycle state")
    automation_paused: bool = Field(False, description="Whether autonomous processing is paused for this RFQ")
    pause_reason: Optional[str] = Field(None, description="Operator-provided reason for pausing automation")
...
class QuoteItem(BaseModel):
    ...
    uom: str = Field("EA", description="Unit of measure for the quoted item")
    ...
    condition: Optional[str] = Field(None, description="Quoted condition code")
...
class Quote(BaseModel):
    ...
    lead_time_days: Optional[int] = Field(None, ge=0, description="Quote lead time in days")
    valid_until: Optional[str] = Field(None, description="Quote validity date")
    version: int = Field(1, ge=1, description="Optimistic concurrency version")
